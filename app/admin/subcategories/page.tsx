    ...
    <tr className="border-t bg-orange-50">
      ...
      <td className="px-5 py-3">
        <input
          ...
          className="w-full rounded-xl border border-orange-300 px-3 py-2 text-sm font-mono outline-none focus:border-orange-500"
        />
      </td>
      ...
      <td className="px-5 py-3">
        <div className="flex gap-2">
          <button
            ...
            onClick={save}
            disabled={saving}
            className="rounded-lg bg-orange-500 p-2 text-white disabled:opacity-50"
          >
            <Check size={15} />
          </button>
          ...
          <button
            ...
            className="rounded-lg border p-2 text-blue-400"
          >
            <X size={15} />
          </button>
        </div>
...
export default function AdminSubcategoriesPage() {
  ...
  async function del(sub: Subcategory) {
    ...
    try {
      await subcategoriesService.delete(sub.id)
      ...
      setToast({
        msg: 'Cannot delete — has products',
        type: 'error',
      })
    }
  }
  ...
  /*
   * Keep FormRow outside AdminSubcategoriesPage.
   *
   * This object is recreated when state changes, but the FormRow
   * component itself is NOT recreated. This prevents the input
   * from being remounted on every keystroke.
   */
        ...
        <div className="section-shell py-8">
          ...
          <div className="flex flex-wrap items-end justify-between gap-4">
            ...
            <button
              type="button"
              onClick={startAdd}
              className="flex items-center gap-2 rounded-lg bg-orange-500 px-4 py-2.5 text-sm font-bold text-white shadow-lg hover:bg-orange-600"
            >
              <Plus size={17} />
              Add subcategory
            </button>
                  ...
                  {loading ? (
                    ...
                    subcategories.map((sub) => (
                      editing === sub.id ? (
                        ...
                        <tr
                          key={sub.id}
                          className="border-t hover:bg-blue-50/60"
                        >
                          ...
                          <td className="px-5 py-4">
                            <div className="flex gap-2">
                              ...
                              <button
                                ...
                                className="rounded-lg p-2 text-blue-400 hover:bg-blue-100 hover:text-blue-700"
                              >
                                <Pencil size={15} />
                              </button>
                              ...
                              <button
                                type="button"
                                onClick={() => del(sub)}
                                className="rounded-lg p-2 text-blue-400 hover:bg-red-50 hover:text-red-500"
                              >
                                <Trash2 size={15} />
                              </button>
            ...
            {!loading &&
              ...
              !adding && (
                <EmptyState
                  ...
                  description="Subcategories help customers browse within a category."
                  action={
                    <button
                      type="button"
                      onClick={startAdd}
